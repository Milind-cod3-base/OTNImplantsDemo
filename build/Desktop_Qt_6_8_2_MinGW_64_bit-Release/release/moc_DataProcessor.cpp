...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sensorDataUpdated((*reinterpret_cast< std::add_pointer_t<SensorData>>(_a[1]))); break;
        case 1: _t->actuatorDataUpdated((*reinterpret_cast< std::add_pointer_t<ActuatorData>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DataProcessor::*)(SensorData );
            if (_q_method_type _q_method = &DataProcessor::sensorDataUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DataProcessor::*)(ActuatorData );
            if (_q_method_type _q_method = &DataProcessor::actuatorDataUpdated; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DataProcessor::sensorDataUpdated(SensorData _t1)
{
...
// SIGNAL 1
void DataProcessor::actuatorDataUpdated(ActuatorData _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
